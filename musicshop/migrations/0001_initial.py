    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default='', max_length=15000, verbose_name='Описание')),
                ('image', models.ImageField(upload_to=utils.uploading.upload_function, verbose_name='Обложка')),
                ('songs_list', models.TextField(max_length=15000, verbose_name='Треклист')),
                ('release_date', models.DateField(verbose_name='Дата релиза')),
                ('price', models.DecimalField(decimal_places=2, max_digits=9, verbose_name='Цена')),
                ('stock', models.PositiveSmallIntegerField(default=0, verbose_name='Наличие товара на складе')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('total_products', models.PositiveSmallIntegerField(default=0, verbose_name='Всего товаров в корзине')),
                ('final_price', models.DecimalField(decimal_places=2, max_digits=9, verbose_name='Общая цена')),
                ('in_order', models.BooleanField(default=False, verbose_name='Уже используется')),
                ('for_anonymous_user', models.BooleanField(default=False, verbose_name='Для зарегистрированного пользователя')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to=utils.uploading.upload_function, verbose_name='Аватарка')),
                ('slug', models.SlugField(unique=True, verbose_name='Слаг')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.TextField(blank=True, max_length=15000, null=True, verbose_name='Комментарий к заказу')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('use_in_slider', models.BooleanField(default=False, verbose_name='Для слайдера')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('qty', models.PositiveSmallIntegerField(default=1, verbose_name='Количество')),
                ('final_price', models.DecimalField(decimal_places=2, max_digits=9, verbose_name='Общая цена')),
                ('object_id', models.PositiveIntegerField()),
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='musicshop.cart', verbose_name='Корзина')),
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
