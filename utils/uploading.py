class ImageUploadHelper:
    ...
    def __init__(self, field_name_to_combine,
                 instance, filename, upload_postfix):
    ...
    def get_field_to_combine_and_upload_postfix(cls, klass):
        ...
        upload_postfix = cls.FILED_TO_COMBINE_MAP.get(
            'upload_postfix', cls.FILED_TO_COMBINE_MAP['default']
            ['upload_postfix']
        )
    ...
    def path(self):
        ...
        # self.instance.__class__.__name__.lower() = member, artist or album
